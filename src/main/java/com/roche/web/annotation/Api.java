 ...
 * Controllers marked with <b>@Api</b> will be registered by {@link com.roche.web.api.ApiRequestMappingHandlerMapping}
 ...
 * be defined on method level. If <i>value</i> parameter is missing, then {@link com.roche.web.api.EmptyPathNamingProvider}
 * is used to determine path. By default {@link com.roche.web.api.BasePathNamingProvider} is used.
 *
 * Example:
 * <pre>
 * @Api(value = "examples",
 ...
 * </pre>
 *
 * Depending on your other configuration of versioning ({@link com.roche.web.api.ApiVersionStrategy}), path
 * prefix ({@link com.roche.web.api.ApiPathEnhancer} and base context ({@link com.roche.web.api.ContextPathEnhancer},
